...
# File: all_test_v4_cc.tcl
# Generated on: Wed Nov 02 09:54:13 2005
...
if {$make_assignments} {
	...
	catch { set_global_assignment -name DEVICE EP1S30F780C5 } result
	...
	catch { set_location_assignment PIN_AD24 -to cardid } result
	catch { set_location_assignment PIN_B12 -to tx } result
	catch { set_location_assignment PIN_AB22 -to led\[0\] } result
	catch { set_location_assignment PIN_AC24 -to led\[1\] } result
	catch { set_location_assignment PIN_AC23 -to led\[2\] } result
	...
	catch { set_location_assignment PIN_AD5 -to dip\[0\] } result
	catch { set_location_assignment PIN_AE4 -to dip\[1\] } result

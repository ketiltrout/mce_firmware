...
# File: all_test.tcl
# Generated on: Wed Nov 02 10:12:01 2005
...
if {$make_assignments} {
	...
	catch { set_global_assignment -name VHDL_FILE ../source/all_test_pack.vhd } result
	...
	catch { set_global_assignment -name DEVICE EP1S10F780C5 } result
	...
	catch { set_location_assignment PIN_T24 -to led\[1\] } result
	catch { set_location_assignment PIN_T23 -to led\[2\] } result
	catch { set_location_assignment PIN_AC9 -to nrst } result
	catch { set_location_assignment PIN_K17 -to inclk } result
	catch { set_location_assignment PIN_V25 -to slot\[0\] } result
	catch { set_location_assignment PIN_V26 -to slot\[1\] } result
	catch { set_location_assignment PIN_T25 -to slot\[2\] } result
	catch { set_location_assignment PIN_T26 -to slot\[3\] } result
	catch { set_location_assignment PIN_M2 -to dip\[0\] } result
	catch { set_location_assignment PIN_N1 -to dip\[1\] } result
	...
	catch { set_global_assignment -name EDA_SHOW_LMF_MAPPING_MESSAGES OFF -section_id eda_design_synthesis } result
	catch { set_global_assignment -name EDA_RUN_TOOL_AUTOMATICALLY OFF -section_id eda_design_synthesis } result
	catch { set_global_assignment -name EDA_INPUT_DATA_FORMAT EDIF -section_id eda_design_synthesis } result

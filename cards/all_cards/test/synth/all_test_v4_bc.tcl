...
# File: all_test_v4_bc.tcl
# Generated on: Wed Nov 02 13:07:01 2005
...
if {$make_assignments} {
	...
	catch { set_location_assignment PIN_AE11 -to rx } result
	catch { set_location_assignment PIN_T21 -to cardid } result
	catch { set_location_assignment PIN_AD8 -to tx } result
	...
	catch { set_location_assignment PIN_W23 -to dip\[0\] } result
	catch { set_location_assignment PIN_W24 -to dip\[1\] } result

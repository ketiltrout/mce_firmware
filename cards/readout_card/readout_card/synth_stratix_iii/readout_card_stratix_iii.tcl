...
# Generated on: Fri Jan 23 12:37:07 2009
...
if {$make_assignments} {
	...
	set_global_assignment -name DEVICE_MIGRATION_LIST "EP3SE50F780C4,EP3SE80F780C4,EP3SL70F780C4"
	set_global_assignment -name TIMEQUEST_MULTICORNER_ANALYSIS ON
	set_global_assignment -name TIMEQUEST_DO_CCPP_REMOVAL ON
	set_global_assignment -name VHDL_FILE ../../ddr2_sdram_ctrl/micron_ctrl_phy.vhd
	set_global_assignment -name VHDL_FILE ../../ddr2_sdram_ctrl/micron_ctrl_ex_lfsr8.vhd
	set_global_assignment -name VHDL_FILE ../../ddr2_sdram_ctrl/micron_ctrl_example_driver.vhd
	set_global_assignment -name VHDL_FILE ../../ddr2_sdram_ctrl/micron_ctrl_phy_alt_mem_phy_pll.vhd
	set_global_assignment -name VHDL_FILE ../../ddr2_sdram_ctrl/alt_mem_phy_sequencer.vhd
	set_global_assignment -name VERILOG_FILE ../../ddr2_sdram_ctrl/micron_ctrl_phy_alt_mem_phy.v
	set_global_assignment -name VHDL_FILE ../../ddr2_sdram_ctrl/micron_ctrl.vhd
	set_global_assignment -name VHDL_FILE ../../ddr2_sdram_ctrl/micron_ctrl_controller_phy.vhd
	...
	set_location_assignment PIN_C1 -to dac_FB1_dat[0]
	set_location_assignment PIN_D1 -to dac_FB1_dat[1]
	set_location_assignment PIN_E1 -to dac_FB1_dat[2]
	set_location_assignment PIN_F1 -to dac_FB1_dat[3]
	set_location_assignment PIN_G1 -to dac_FB1_dat[4]
	set_location_assignment PIN_H1 -to dac_FB1_dat[5]
	set_location_assignment PIN_J1 -to dac_FB1_dat[6]
	set_location_assignment PIN_H2 -to dac_FB1_dat[7]
	set_location_assignment PIN_G2 -to dac_FB1_dat[8]
	set_location_assignment PIN_E2 -to dac_FB1_dat[9]
	set_location_assignment PIN_D2 -to dac_FB1_dat[10]
	set_location_assignment PIN_G3 -to dac_FB1_dat[11]
	set_location_assignment PIN_F3 -to dac_FB1_dat[12]
	set_location_assignment PIN_J3 -to dac_FB1_dat[13]
	set_location_assignment PIN_J16 -to dac_FB2_dat[0]
	set_location_assignment PIN_G16 -to dac_FB2_dat[1]
	set_location_assignment PIN_H16 -to dac_FB2_dat[2]
	set_location_assignment PIN_A19 -to dac_FB2_dat[3]
	set_location_assignment PIN_B16 -to dac_FB2_dat[4]
	set_location_assignment PIN_B17 -to dac_FB2_dat[5]
	set_location_assignment PIN_B19 -to dac_FB2_dat[6]
	set_location_assignment PIN_C15 -to dac_FB2_dat[7]
	set_location_assignment PIN_C17 -to dac_FB2_dat[8]
	set_location_assignment PIN_C18 -to dac_FB2_dat[9]
	set_location_assignment PIN_C19 -to dac_FB2_dat[10]
	set_location_assignment PIN_D15 -to dac_FB2_dat[11]
	set_location_assignment PIN_D16 -to dac_FB2_dat[12]
	set_location_assignment PIN_D17 -to dac_FB2_dat[13]
	set_location_assignment PIN_A3 -to dac_FB3_dat[0]
	set_location_assignment PIN_A4 -to dac_FB3_dat[1]
	set_location_assignment PIN_A5 -to dac_FB3_dat[2]
	set_location_assignment PIN_A6 -to dac_FB3_dat[3]
	set_location_assignment PIN_A7 -to dac_FB3_dat[4]
	set_location_assignment PIN_A8 -to dac_FB3_dat[5]
	set_location_assignment PIN_A9 -to dac_FB3_dat[6]
	set_location_assignment PIN_B2 -to dac_FB3_dat[7]
	set_location_assignment PIN_B4 -to dac_FB3_dat[8]
	set_location_assignment PIN_B5 -to dac_FB3_dat[9]
	set_location_assignment PIN_B7 -to dac_FB3_dat[10]
	set_location_assignment PIN_B8 -to dac_FB3_dat[11]
	set_location_assignment PIN_C3 -to dac_FB3_dat[12]
	set_location_assignment PIN_C5 -to dac_FB3_dat[13]
	set_location_assignment PIN_J19 -to dac_FB4_dat[0]
	set_location_assignment PIN_A22 -to dac_FB4_dat[1]
	set_location_assignment PIN_A23 -to dac_FB4_dat[2]
	set_location_assignment PIN_A21 -to dac_FB4_dat[3]
	set_location_assignment PIN_J20 -to dac_FB4_dat[4]
	set_location_assignment PIN_A26 -to dac_FB4_dat[5]
	set_location_assignment PIN_A27 -to dac_FB4_dat[6]
	set_location_assignment PIN_B22 -to dac_FB4_dat[7]
	set_location_assignment PIN_B23 -to dac_FB4_dat[8]
	set_location_assignment PIN_B20 -to dac_FB4_dat[9]
	set_location_assignment PIN_B25 -to dac_FB4_dat[10]
	set_location_assignment PIN_B26 -to dac_FB4_dat[11]
	set_location_assignment PIN_A25 -to dac_FB4_dat[12]
	set_location_assignment PIN_C21 -to dac_FB4_dat[13]
	set_location_assignment PIN_D22 -to dac_FB5_dat[0]
	set_location_assignment PIN_D24 -to dac_FB5_dat[1]
	set_location_assignment PIN_D25 -to dac_FB5_dat[2]
	set_location_assignment PIN_E22 -to dac_FB5_dat[3]
	set_location_assignment PIN_E23 -to dac_FB5_dat[4]
	set_location_assignment PIN_E20 -to dac_FB5_dat[5]
	set_location_assignment PIN_F19 -to dac_FB5_dat[6]
	set_location_assignment PIN_F20 -to dac_FB5_dat[7]
	set_location_assignment PIN_F21 -to dac_FB5_dat[8]
	set_location_assignment PIN_F22 -to dac_FB5_dat[9]
	set_location_assignment PIN_G18 -to dac_FB5_dat[10]
	set_location_assignment PIN_G20 -to dac_FB5_dat[11]
	set_location_assignment PIN_G21 -to dac_FB5_dat[12]
	set_location_assignment PIN_G22 -to dac_FB5_dat[13]
	set_location_assignment PIN_L1 -to dac_FB6_dat[0]
	set_location_assignment PIN_N1 -to dac_FB6_dat[1]
	set_location_assignment PIN_M1 -to dac_FB6_dat[2]
	set_location_assignment PIN_K2 -to dac_FB6_dat[3]
	set_location_assignment PIN_L2 -to dac_FB6_dat[4]
	set_location_assignment PIN_N2 -to dac_FB6_dat[5]
	set_location_assignment PIN_L3 -to dac_FB6_dat[6]
	set_location_assignment PIN_P3 -to dac_FB6_dat[7]
	set_location_assignment PIN_M3 -to dac_FB6_dat[8]
	set_location_assignment PIN_L4 -to dac_FB6_dat[9]
	set_location_assignment PIN_P4 -to dac_FB6_dat[10]
	set_location_assignment PIN_M4 -to dac_FB6_dat[11]
	set_location_assignment PIN_N4 -to dac_FB6_dat[12]
	set_location_assignment PIN_L5 -to dac_FB6_dat[13]
	set_location_assignment PIN_AF1 -to dac_FB7_dat[0]
	set_location_assignment PIN_AE1 -to dac_FB7_dat[1]
	set_location_assignment PIN_AD1 -to dac_FB7_dat[2]
	set_location_assignment PIN_AC1 -to dac_FB7_dat[3]
	set_location_assignment PIN_AA1 -to dac_FB7_dat[4]
	set_location_assignment PIN_AB1 -to dac_FB7_dat[5]
	set_location_assignment PIN_Y1 -to dac_FB7_dat[6]
	set_location_assignment PIN_AE2 -to dac_FB7_dat[7]
	set_location_assignment PIN_AF2 -to dac_FB7_dat[8]
	set_location_assignment PIN_AC2 -to dac_FB7_dat[9]
	set_location_assignment PIN_AB2 -to dac_FB7_dat[10]
	set_location_assignment PIN_Y2 -to dac_FB7_dat[11]
	set_location_assignment PIN_W2 -to dac_FB7_dat[12]
	set_location_assignment PIN_AB4 -to dac_FB7_dat[13]
	set_location_assignment PIN_V1 -to dac_FB8_dat[0]
	set_location_assignment PIN_W1 -to dac_FB8_dat[1]
	set_location_assignment PIN_R10 -to dac_FB8_dat[2]
	set_location_assignment PIN_T2 -to dac_FB8_dat[3]
	set_location_assignment PIN_V3 -to dac_FB8_dat[4]
	set_location_assignment PIN_U3 -to dac_FB8_dat[5]
	set_location_assignment PIN_T3 -to dac_FB8_dat[6]
	set_location_assignment PIN_V4 -to dac_FB8_dat[7]
	set_location_assignment PIN_T4 -to dac_FB8_dat[8]
	set_location_assignment PIN_U4 -to dac_FB8_dat[9]
	set_location_assignment PIN_R4 -to dac_FB8_dat[10]
	set_location_assignment PIN_T5 -to dac_FB8_dat[11]
	set_location_assignment PIN_T6 -to dac_FB8_dat[12]
	set_location_assignment PIN_U6 -to dac_FB8_dat[13]
	set_location_assignment PIN_B1 -to dac_FB_clk[0]
	set_location_assignment PIN_A15 -to dac_FB_clk[1]
	set_location_assignment PIN_A2 -to dac_FB_clk[2]
	set_location_assignment PIN_A20 -to dac_FB_clk[3]
	set_location_assignment PIN_D21 -to dac_FB_clk[4]
	set_location_assignment PIN_K1 -to dac_FB_clk[5]
	set_location_assignment PIN_AG1 -to dac_FB_clk[6]
	set_location_assignment PIN_U1 -to dac_FB_clk[7]
	set_location_assignment PIN_F4 -to dac_clk[0]
	set_location_assignment PIN_E17 -to dac_clk[1]
	set_location_assignment PIN_C9 -to dac_clk[2]
	set_location_assignment PIN_D19 -to dac_clk[3]
	set_location_assignment PIN_H19 -to dac_clk[4]
	set_location_assignment PIN_M6 -to dac_clk[5]
	set_location_assignment PIN_W3 -to dac_clk[6]
	set_location_assignment PIN_U7 -to dac_clk[7]
	set_location_assignment PIN_H3 -to dac_dat[0]
	set_location_assignment PIN_F17 -to dac_dat[1]
	set_location_assignment PIN_D7 -to dac_dat[2]
	set_location_assignment PIN_D20 -to dac_dat[3]
	set_location_assignment PIN_J18 -to dac_dat[4]
	set_location_assignment PIN_N9 -to dac_dat[5]
	set_location_assignment PIN_AC4 -to dac_dat[6]
	set_location_assignment PIN_U8 -to dac_dat[7]
	set_location_assignment PIN_H4 -to bias_dac_ncs[0]
	set_location_assignment PIN_D18 -to bias_dac_ncs[1]
	set_location_assignment PIN_C6 -to bias_dac_ncs[2]
	set_location_assignment PIN_C23 -to bias_dac_ncs[3]
	set_location_assignment PIN_D23 -to bias_dac_ncs[4]
	set_location_assignment PIN_N5 -to bias_dac_ncs[5]
	set_location_assignment PIN_AB3 -to bias_dac_ncs[6]
	set_location_assignment PIN_U5 -to bias_dac_ncs[7]
	set_location_assignment PIN_G4 -to offset_dac_ncs[0]
	set_location_assignment PIN_E16 -to offset_dac_ncs[1]
	set_location_assignment PIN_C8 -to offset_dac_ncs[2]
	set_location_assignment PIN_C24 -to offset_dac_ncs[3]
	set_location_assignment PIN_H20 -to offset_dac_ncs[4]
	set_location_assignment PIN_L6 -to offset_dac_ncs[5]
	set_location_assignment PIN_Y3 -to offset_dac_ncs[6]
	set_location_assignment PIN_T8 -to offset_dac_ncs[7]
	set_location_assignment PIN_AE11 -to lvds_spare
	set_location_assignment PIN_AE12 -to lvds_txa
	set_location_assignment PIN_AG12 -to lvds_txb
	...
	set_location_assignment PIN_AH10 -to ttl_in2
	set_location_assignment PIN_AE13 -to ttl_out2
	set_location_assignment PIN_Y13 -to ttl_dir3
	set_location_assignment PIN_AG10 -to ttl_in3
	set_location_assignment PIN_Y14 -to ttl_out3
	set_location_assignment PIN_M25 -to red_led
	set_location_assignment PIN_N25 -to ylw_led
	set_location_assignment PIN_M24 -to grn_led
	...
	set_location_assignment PIN_N20 -to smb_data
	...
	set_location_assignment PIN_N24 -to rst_n
	set_location_assignment PIN_AH11 -to ttl_in1
	set_location_assignment PIN_AC12 -to slot_id[0]
	set_location_assignment PIN_AF12 -to slot_id[1]
	set_location_assignment PIN_AF11 -to slot_id[2]
	set_location_assignment PIN_AF10 -to slot_id[3]
	set_location_assignment PIN_AD12 -to lvds_sync
	set_location_assignment PIN_AC11 -to lvds_cmd

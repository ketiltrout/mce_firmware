...
# Revision history:
#
# $Log: rc_pin_assign_revB.tcl,v $
# Revision 1.1  2006/05/11 21:59:46  bench2
# rc_test rev. 4
#
...
# in Rev. B boards RS232 rx and tx are moved to B12 and C12, mictor pins
...
# assign rs232 pins , in Rev B cards these are double assigned with mictor pins
...
cmp add_assignment $top_name "" "mictor\[10\]" LOCATION "Pin_D11"
cmp add_assignment $top_name "" "mictor\[11\]" LOCATION "Pin_D13"
cmp add_assignment $top_name "" "mictor\[12\]" LOCATION "Pin_E13"
...
cmp add_assignment $top_name "" "mictor\[19\]" LOCATION "Pin_A8"
cmp add_assignment $top_name "" "mictor\[20\]" LOCATION "Pin_C8"
cmp add_assignment $top_name "" "mictor\[21\]" LOCATION "Pin_D8"
cmp add_assignment $top_name "" "mictor\[22\]" LOCATION "Pin_A7"
cmp add_assignment $top_name "" "mictor\[23\]" LOCATION "Pin_B7"
cmp add_assignment $top_name "" "mictor\[24\]" LOCATION "Pin_C7"
cmp add_assignment $top_name "" "mictor\[25\]" LOCATION "Pin_A6"
cmp add_assignment $top_name "" "mictor\[26\]" LOCATION "Pin_C6"
cmp add_assignment $top_name "" "mictor\[27\]" LOCATION "Pin_D6"
cmp add_assignment $top_name "" "mictor\[28\]" LOCATION "Pin_D9"
...
# assign serial DAC
cmp add_assignment $top_name "" "dac_clk\[0\]" LOCATION "Pin_AE8"
cmp add_assignment $top_name "" "dac_clk\[1\]" LOCATION "Pin_Y10"
cmp add_assignment $top_name "" "dac_clk\[2\]" LOCATION "Pin_AB7"
cmp add_assignment $top_name "" "dac_clk\[3\]" LOCATION "Pin_AC5"
cmp add_assignment $top_name "" "dac_clk\[4\]" LOCATION "Pin_AG20"
cmp add_assignment $top_name "" "dac_clk\[5\]" LOCATION "Pin_AB22"
cmp add_assignment $top_name "" "dac_clk\[6\]" LOCATION "Pin_AB20"
cmp add_assignment $top_name "" "dac_clk\[7\]" LOCATION "Pin_AB18"
cmp add_assignment $top_name "" "dac_dat\[0\]" LOCATION "Pin_AG10"
cmp add_assignment $top_name "" "dac_dat\[1\]" LOCATION "Pin_Y11"
cmp add_assignment $top_name "" "dac_dat\[2\]" LOCATION "Pin_AB8"
cmp add_assignment $top_name "" "dac_dat\[3\]" LOCATION "Pin_AC6"
cmp add_assignment $top_name "" "dac_dat\[4\]" LOCATION "Pin_AE23"
cmp add_assignment $top_name "" "dac_dat\[5\]" LOCATION "Pin_AE25"
cmp add_assignment $top_name "" "dac_dat\[6\]" LOCATION "Pin_Y20"
cmp add_assignment $top_name "" "dac_dat\[7\]" LOCATION "Pin_V18"
cmp add_assignment $top_name "" "bias_dac_ncs\[0\]" LOCATION "Pin_AH3"
cmp add_assignment $top_name "" "bias_dac_ncs\[1\]" LOCATION "Pin_V11"
cmp add_assignment $top_name "" "bias_dac_ncs\[2\]" LOCATION "Pin_AA9"
cmp add_assignment $top_name "" "bias_dac_ncs\[3\]" LOCATION "Pin_AB9"
cmp add_assignment $top_name "" "bias_dac_ncs\[4\]" LOCATION "Pin_AH16"
...
cmp add_assignment $top_name "" "offset_dac_ncs\[4\]" LOCATION "Pin_AF18"
cmp add_assignment $top_name "" "offset_dac_ncs\[5\]" LOCATION "Pin_AC23"
cmp add_assignment $top_name "" "offset_dac_ncs\[6\]" LOCATION "Pin_AB21"
cmp add_assignment $top_name "" "offset_dac_ncs\[7\]" LOCATION "Pin_AC20"

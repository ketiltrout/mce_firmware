...
ARCHITECTURE SYN OF micron_ctrl IS
	...
	COMPONENT micron_ctrl_controller_phy
	PORT (
		local_address	: IN STD_LOGIC_VECTOR (22 DOWNTO 0);
		local_write_req	: IN STD_LOGIC;
		local_read_req	: IN STD_LOGIC;
...
BEGIN
	...
	micron_ctrl_controller_phy_inst : micron_ctrl_controller_phy
	PORT MAP (
...
-- Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.DDRControllerMVCModel"  active_core="micron_ctrl_controller_phy" >
...
-- Retrieval info:      <PRIVATE name = "alt_top" value="micron_ctrl_auk_ddr_hp_controller_wrapper"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "nativelink_excludes" value="alt_mem_phy_sequencer.vhd,micron_ctrl_phy_alt_mem_phy_sequencer_wrapper.vhd,micron_ctrl_phy_alt_mem_phy_sequencer_wrapper.v,micron_ctrl_phy.vhd,micron_ctrl_phy_alt_mem_phy.v,alt_mem_phy_defines.v"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "nativelink_includes" value="micron_ctrl_phy_alt_mem_phy_delay.vhd,micron_ctrl_phy.vho,micron_ctrl_phy_alt_mem_phy_sequencer_wrapper.vho"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "family" value="Stratix III"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "filename" value="micron_ctrl_auk_ddr_hp_controller_wrapper.vho"  type="STRING"  enable="1" />
-- Retrieval info:     </NAMESPACE>
-- Retrieval info:     <NAMESPACE name = "simgen2">
-- Retrieval info:      <PRIVATE name = "family" value="Stratix III"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "command" value="--simgen_arbitrary_blackbox=+micron_ctrl_alt_mem_phy_sequencer_wrapper;+micron_ctrl_alt_mem_phy_reconfig;+micron_ctrl_alt_mem_phy_pll;+micron_ctrl_phy_alt_mem_phy_delay --ini=simgen_tri_bus_opt=on"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "parameter" value="SIMGEN_INITIALIZATION_FILE=C:\mce\cards\readout_card\ddr2_sdram_ctrl/micron_ctrl_simgen_init.txt"  type="STRING"  enable="1" />
-- Retrieval info:     </NAMESPACE>
...
-- Retrieval info:      <PRIVATE name = "filename" value="micron_ctrl_syn.v"  type="STRING"  enable="1" />
-- Retrieval info:     </NAMESPACE>

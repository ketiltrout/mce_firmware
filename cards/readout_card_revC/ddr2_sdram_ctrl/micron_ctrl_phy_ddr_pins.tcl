...
set outputFileName "micron_ctrl_phy_autodetectedpins.tcl"
...
set micron_ctrl_phy_use_high_performance_timing 1
if {[namespace which -variable ::override_micron_ctrl_phy_use_high_performance_timing] != ""} {
  set micron_ctrl_phy_use_high_performance_timing $::override_micron_ctrl_phy_use_high_performance_timing
}

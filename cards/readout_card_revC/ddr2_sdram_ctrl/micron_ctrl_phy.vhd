...
BEGIN
	...
	micron_ctrl_phy_alt_mem_phy_inst : micron_ctrl_phy_alt_mem_phy
	GENERIC MAP (
		ADDR_CMD_2T_EN => 1,
...
-- Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.DDRPHYMVCModel"  active_core="micron_ctrl_phy_alt_mem_phy" >
...
-- Retrieval info:      <PRIVATE name = "alt_top" value="micron_ctrl_phy_alt_mem_phy_sequencer_wrapper"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "nativelink_includes" value="micron_ctrl_phy_alt_mem_phy_delay.vhd"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "family" value="Stratix III"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "filename" value="micron_ctrl_phy_alt_mem_phy_sequencer_wrapper.vho"  type="STRING"  enable="1" />
-- Retrieval info:     </NAMESPACE>
-- Retrieval info:     <NAMESPACE name = "simgen2">
-- Retrieval info:      <PRIVATE name = "family" value="Stratix III"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "command" value="--simgen_arbitrary_blackbox=+micron_ctrl_phy_alt_mem_phy_sequencer_wrapper;+micron_ctrl_phy_alt_mem_phy_reconfig;+micron_ctrl_phy_alt_mem_phy_pll;+micron_ctrl_phy_alt_mem_phy_delay --ini=simgen_tri_bus_opt=on"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "parameter" value="SIMGEN_INITIALIZATION_FILE=C:\mce\cards\readout_card\ddr2_sdram_ctrl/micron_ctrl_phy_simgen_init.txt"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "filename" value="micron_ctrl_phy.vho"  type="STRING"  enable="1" />
-- Retrieval info:     </NAMESPACE>
...
-- Retrieval info:      <PRIVATE name = "filename" value="micron_ctrl_phy_syn.v"  type="STRING"  enable="1" />
-- Retrieval info:     </NAMESPACE>

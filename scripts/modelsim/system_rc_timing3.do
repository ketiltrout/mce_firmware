...
add wave -noupdate -format Literal -label Row -radix decimal /tb_cc_rcs_bcs_ac/i_readout_card1/i_flux_loop/i_flux_loop_ctrl_ch1/i_fsfb_calc/i_fsfb_io_controller/ctrl_rd_addr
...
add wave -noupdate -format Literal -label {Row (to store FB)} -radix decimal /tb_cc_rcs_bcs_ac/i_readout_card1/i_flux_loop/i_flux_loop_ctrl_ch0/i_fsfb_calc/fsfb_queue_wr_addr_o
add wave -noupdate -format Literal -radix unsigned /tb_cc_rcs_bcs_ac/i_readout_card1/i_flux_loop/i_flux_loop_ctrl_ch0/i_fsfb_calc/fsfb_fltr_wr_addr_o
...
add wave -noupdate -format Logic /tb_cc_rcs_bcs_ac/i_readout_card1/i_flux_loop/i_flux_loop_ctrl_ch0/i_fsfb_calc/fsfb_queue_wr_en_bank0_o
add wave -noupdate -format Logic /tb_cc_rcs_bcs_ac/i_readout_card1/i_flux_loop/i_flux_loop_ctrl_ch0/i_fsfb_calc/fsfb_queue_wr_en_bank1_o
...
add wave -noupdate -format Logic /tb_cc_rcs_bcs_ac/i_readout_card1/adc1_clk
add wave -noupdate -format Literal -radix decimal /tb_cc_rcs_bcs_ac/i_readout_card1/adc1_dat
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {1086259999 ps} 0} {{Cursor 2} {2079601799 ps} 0}
...
update
WaveRestoreZoom {1058400 ns} {1104600 ns}

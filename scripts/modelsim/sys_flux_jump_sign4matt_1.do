...
add wave -noupdate -color {Sky Blue} -format Logic -itemcolor {Sky Blue} -label FB_DAC_clk /tb_cc_rcs_bcs_ac/i_readout_card1/dac_fb_clk(0)
...
add wave -noupdate -format Literal -radix hexadecimal /tb_cc_rcs_bcs_ac/i_readout_card1/i_flux_loop/i_flux_loop_ctrl_ch0/i_fsfb_calc/const_val_i
...
add wave -noupdate -color gold -format Logic -itemcolor gold -radix hexadecimal /tb_cc_rcs_bcs_ac/i_readout_card1/i_flux_loop/i_fsfb_corr/flux_jumping_en_i
add wave -noupdate -format Literal -radix decimal /tb_cc_rcs_bcs_ac/i_readout_card1/i_flux_loop/i_flux_loop_ctrl_ch0/i_fsfb_calc/i_fsfb_io_controller/ctrl_dat
...
WaveRestoreCursors {{Cursor 1} {640191061 ps} 0} {{Row 7 asserted by AC} {2025994484 ps} 0}
...
update
WaveRestoreZoom {2013620539 ps} {2035441260 ps}
